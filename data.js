const meetings = [
  ...
  {audience:["Adult Family Members and Friends"],dataSource:"na",duration:90,facilitator:[694],id:8070,language:"English",location:"Oakland, California",program:"Family & Friends",schedule:{day:1,time:"23:00Z"},type:"Online"},
  ...
  {audience:["Adults Welcome","Family & Friends Only"],dataSource:"uk",duration:90,facilitator:[2079,2094],id:1022,language:"English",location:"Chester, GB",program:"Family & Friends",schedule:{day:0,time:"11:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:null,facilitator:[902],id:1055,language:"English",location:"Glasgow, GB",program:"SMART Recovery",schedule:{day:2,time:"07:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2090],id:1056,language:"English",location:"Woking, GB",program:"SMART Recovery",schedule:{day:4,time:"04:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2090],id:1057,language:"English",location:"Sutton (and Epsom), Epsom, GB",program:"SMART Recovery",schedule:{day:3,time:"12:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2090],id:1058,language:"English",location:"Epsom, GB",program:"SMART Recovery",schedule:{day:0,time:"04:00Z"},type:"Online"},
  ...
  {audience:["Adults Welcome"],dataSource:"uk",duration:90,facilitator:[579],id:1062,language:"English",location:"Warwickshire, Warwickshire, GB",program:"SMART Recovery",schedule:{day:3,time:"13:00Z"},type:"Online"},
  ...
  {audience:["Women Only"],dataSource:"uk",duration:90,facilitator:[2095],id:1064,language:"English",location:"Woking, GB",program:"SMART Recovery",schedule:{day:2,time:"05:30Z"},type:"Online"},
  {audience:["Adults Welcome"],dataSource:"uk",duration:90,facilitator:[588,2070],id:1071,language:"English",location:"Weymouth, GB",program:"SMART Recovery",schedule:{day:2,time:"13:30Z"},type:"Online"},
  {audience:["Adults Welcome"],dataSource:"uk",duration:null,facilitator:[597],id:1076,language:"English",location:"Inverness, GB",program:"SMART Recovery",schedule:{day:1,time:"08:00Z"},type:"Online"},
  {audience:["Family & Friends Only"],dataSource:"uk",duration:90,facilitator:[2089],id:1079,language:"English",location:"London, GB",program:"Family & Friends",schedule:{day:0,time:"11:45Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:null,facilitator:[717],id:1083,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:1,time:"13:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[595],id:1084,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:3,time:"13:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2060],id:1085,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:4,time:"02:00Z"},type:"Online"},
  {audience:["Adults Welcome","Family & Friends Only","National Online Meeting"],canceled:"2026-08-31 13:30:00-05",dataSource:"uk",duration:90,facilitator:[2056],id:1086,language:"English",location:"London, GB",program:"Family & Friends",schedule:{day:0,time:"13:30Z"},type:"Online"},
  {audience:["Adults Welcome","Family & Friends Only","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[597,2081],id:1087,language:"English",location:"London, GB",program:"Family & Friends",schedule:{day:3,time:"13:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting","Women Only"],dataSource:"uk",duration:90,facilitator:[2066],id:1088,language:"English",location:"Telford, GB",program:"SMART Recovery",schedule:{day:3,time:"09:00Z"},type:"Online"},
  {audience:["Adults Welcome"],dataSource:"uk",duration:120,facilitator:[2074],id:1116,language:"Polski",location:"Edinburgh, GB",program:"SMART Recovery",schedule:{day:2,time:"13:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting","Women Only"],dataSource:"uk",duration:90,facilitator:[2057],id:1119,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:0,time:"06:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[601],id:1125,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:6,time:"05:00Z"},type:"Online"},
  {audience:["Military Veterans","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2059],id:1157,language:"English",location:"London, GB",program:"SMART Veterans",schedule:{day:0,time:"13:30Z"},type:"Online"},
  {audience:["Military Veterans","National Online Meeting"],dataSource:"uk",duration:null,facilitator:[2093],id:1161,language:"English",location:"London, GB",program:"SMART Veterans",schedule:{day:2,time:"08:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[902],id:1199,language:"English",location:"Nationwide",program:"SMART Recovery",schedule:{day:5,time:"05:00Z"},type:"Online"},
  {audience:["Adults Welcome","Military Veterans"],dataSource:"uk",duration:null,facilitator:[2091],id:1201,language:"English",location:"Stevenage, GB",program:"SMART Veterans",schedule:{day:1,time:"12:30Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:90,facilitator:[2062,2088],id:1226,language:"Punjabi",location:"London, GB",program:"SMART Recovery",schedule:{day:6,time:"02:00Z"},type:"Online"},
  {audience:["Adults Welcome","National Online Meeting"],dataSource:"uk",duration:null,facilitator:[846],id:1229,language:"English",location:"London, GB",program:"SMART Recovery",schedule:{day:2,time:"04:00Z"},type:"Online"},
  {audience:["Adults Welcome"],dataSource:"uk",duration:90,facilitator:[2054,2092],id:1250,language:"English",location:"Harrogate, GB",program:"SMART Recovery",schedule:{day:3,time:"08:00Z"},type:"Online"},
  {audience:["Adults Welcome","Family & Friends Only"],dataSource:"uk",duration:60,facilitator:[980],id:1253,language:"English",location:"London, SW1A 2, GB",program:"Family & Friends",schedule:{day:3,time:"05:00Z"},type:"Online"},
  {audience:["Adults Welcome","LGBTQIA+"],dataSource:"uk",duration:null,facilitator:[2064,2086],id:1287,language:"English",location:"Sheffield, S1 4PT, GB",program:"SMART Recovery",schedule:{day:1,time:"12:00Z"},type:"Online"},
  {audience:["Adults Welcome","Family & Friends Only"],dataSource:"uk",duration:90,facilitator:[2069],id:1348,language:"English",location:"Blackwood, NP12, GB",program:"Family & Friends",schedule:{day:2,time:"11:30Z"},type:"Online"},
  {audience:["Adults Welcome","Family & Friends Only"],dataSource:"uk",duration:90,facilitator:[2082],id:1400,language:"English",location:"Barnet, London Borough of Barnet, GB",program:"Family & Friends",schedule:{day:1,time:"09:00Z"},type:"Online"},
  {audience:["Adults Welcome"],dataSource:"uk",duration:60,facilitator:[1379,1380],id:879,language:"English",location:"Leicester, GB",program:"SMART Recovery",schedule:{day:0,time:"09:00Z"},type:"Online"},
  ...
  {audience:["Adults Welcome"],canceled:"2026-08-28 06:00:00-05",dataSource:"uk",duration:90,facilitator:[1768],id:921,language:"English",location:"Kirkintilloch, GB",program:"SMART Recovery",schedule:{day:4,time:"06:00Z"},type:"Online"},
  {audience:["Adults Welcome","LGBT"],dataSource:"uk",duration:90,facilitator:[2076],id:998,language:"English",location:"LGBT Foundation, Fairbairn House (2nd Floor), Manchester, M1 3NJ, GB",program:"SMART Recovery",schedule:{day:3,time:"12:00Z"},type:"Online, In-person"}
];
const facilitators = {
  ...
  750:["David S."],
  751:["Brettney T."],
  752:["Shiv Sharma","Global"],
  753:["Dr. Bhagat Ram","Global"],
  754:["Brent F"],
  758:["Jaime Fivecoat"],
  759:["Jacob Johnson"],
  761:["Steve Hosmer"],
  ...
  2051:["Randy H."],
  2054:["Andrea Whitton"],
  2055:["Anna Clover-Brown"],
  2056:["Anne Devenport"],
  2057:["Cerys Williams"],
  2059:["Chris Paling","GB"],
  2060:["Daniel Howell"],
  2062:["Dr. Bhagat Ram","GB"],
  2064:["Ekeoma Onwukwe"],
  2066:["Emma Sharp-Lau"],
  2069:["Hayley Sarah","GB"],
  2070:["Indy Noble"],
  2073:["Kevin Morris"],
  2074:["Klaudia Rzeczkowska","GB"],
  2076:["Louise McIvor"],
  2079:["Matt Flegg"],
  2081:["Nadine Humpreys"],
  2082:["Natasha Gwynnette","GB"],
  2086:["Samantha Critchley","GB"],
  2088:["Shiv Sharma","GB"],
  2089:["Simon Jackson"],
  2090:["Steve Saunders"],
  2091:["Stuart Mendelson"],
  2092:["Travis Kyle"],
  2093:["UK SMART Recovery"],
  2094:["Will Benson"],
  2095:["Womens Support Centre, Surrey"]
};
const cachedAt = "2026-08-24T21:07:07Z";
